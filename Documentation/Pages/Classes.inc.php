<div class="xsdoc-file">
    ...
    <div class="xsdoc-file-toc">
        ...
        <ul>
            ...
            <li>Class ID declaration/definition</li>
        </ul>
        <h3><a href="#example">Example</a></h3>
        <ul>
            <li>Public header - PointObject.h</li>
            <li>Private header - PointObjectPrivate.h</li>
            <li>Implementation - PointObject.c</li>
        </ul>
